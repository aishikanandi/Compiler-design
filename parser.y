...
F:  TOKEN_NOT F| UNSTMT| TOKEN_NEGATION F | TOKEN_LP F EXPRESSION_COMMA TOKEN_RP| TOKEN_LP WITHOUT_VAR_LET_CONST EXPRESSION_COMMA TOKEN_RP|  E;
E:   E TOKEN_COMP_OPERATOR E| E TOKEN_PLUS E|E TOKEN_MINUS E|E TOKEN_BIN_OPERATOR E| E TOKEN_ANDOR E | TOKEN_LP E EXPRESSION_COMMA TOKEN_RP| D| F_TERNARY_RIGHT;
...
TOKENID: TOKEN_IDENTIFIER | TOKEN_IDENTIFIER TOKEN_DOT TOKEN_IDENTIFIER| F_TERNARY_LEFT| TOKEN_LP TOKENID EXPRESSION_COMMA TOKEN_RP;
...
ASSIGNMENT_COMMA1: | TOKEN_COMMA WITHOUT_VAR_LET_CONST| TOKEN_COMMA F;
EXPRESSION_COMMA: | TOKEN_COMMA F EXPRESSION_COMMA| TOKEN_COMMA WITHOUT_VAR_LET_CONST EXPRESSION_COMMA;
