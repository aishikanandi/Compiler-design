...
%start S
%token TOKEN_KEYWORD TOKEN_PSEUDOKEYWORD TOKEN_AWAIT TOKEN_NULL TOKEN_BIN_OPERATOR TOKEN_VARIABLE TOKEN_CONST TOKEN_LET TOKEN_SMCLN TOKEN_EQUAL TOKEN_NOT TOKEN_LC TOKEN_RC TOKEN_WHILE TOKEN_DO TOKEN_FOR TOKEN_IF TOKEN_ELSE TOKEN_LR TOKEN_RR TOKEN_LP TOKEN_RP TOKEN_COMMA TOKEN_COMMENTS TOKEN_MULTI_COMMENTS TOKEN_HASHBANG_COMMENT TOKEN_PRINT TOKEN_SOME_OPERATOR TOKEN_OPERATOR TOKEN_SPACE TOKEN_PRIVATE_IDENTIFIER TOKEN_UNARY_OPERATOR TOKEN_DOT TOKEN_ANDOR TOKEN_FUNCTION TOKEN_RETURN TOKEN_IN TOKEN_NEW
...
//Assignment 
ASS: F|TOKEN_VARIABLE TOKEN_IDENTIFIER TOKEN_EQUAL MULTI_EQUAL| TOKEN_LET TOKEN_IDENTIFIER TOKEN_EQUAL MULTI_EQUAL| TOKEN_CONST TOKEN_IDENTIFIER TOKEN_EQUAL MULTI_EQUAL| TOKEN_VARIABLE TOKEN_IDENTIFIER TOKEN_EQUAL F ASSIGNMENT_COMMA2| TOKEN_CONST TOKEN_IDENTIFIER TOKEN_EQUAL F ASSIGNMENT_COMMA2 | TOKEN_LET TOKEN_IDENTIFIER TOKEN_EQUAL F ASSIGNMENT_COMMA2 | UNINITIALIZED | WITHOUT_VAR_LET_CONST;
...
ASSIGNMENT_COMMA1: | TOKEN_COMMA WITHOUT_VAR_LET_CONST| TOKEN_COMMA TOKENID; 
...
MULTI_EQUAL: TOKEN_IDENTIFIER TOKEN_EQUAL MULTI_EQUAL| F|TOKEN_IDENTIFIER| FUNC| TOKEN_IDENTIFIER TOKEN_DOT TOKEN_IDENTIFIER|  TOKEN_LP F EXPRESSION_COMMA TOKEN_RP TOKEN_QUESTION_MARK F TOKEN_COLON F;
MULTI_EQUAL2: MULTI_EQUAL | TOKENID TOKEN_EQUAL MULTI_EQUAL2
//Expressions
F:  TOKEN_NOT F| UNSTMT| TOKEN_NEGATION F | TOKEN_LP F EXPRESSION_COMMA TOKEN_RP| TOKEN_LP WITHOUT_VAR_LET_CONST EXPRESSION_COMMA TOKEN_RP|  E| ARRAY| F| FUNC;
E:   E TOKEN_COMP_OPERATOR E| E TOKEN_PLUS E|E TOKEN_MINUS E|E TOKEN_BIN_OPERATOR E| E TOKEN_ANDOR E | TOKEN_LP E EXPRESSION_COMMA TOKEN_RP| D| F_TERNARY_RIGHT| ARRAY| FUNC;
